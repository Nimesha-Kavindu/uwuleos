        ...
        <div className="relative rounded-3xl bg-gradient-to-r from-leo-dark via-leo-navy to-leo-blue text-white p-10 sm:p-14 lg:p-16 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-white/10 text-leo-cyan text-xs font-bold uppercase tracking-wider backdrop-blur-md border border-white/15">
              ...
              <span>Join the Premier University Youth Service Movement</span>
            </div>
            ...
            <p className="text-slate-200 text-base sm:text-lg leading-relaxed max-w-2xl">
              Unlock transformative leadership opportunities, build lasting university fellowship, and make a tangible humanitarian difference in Uva Province and beyond.
            </p>
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-white/10 hover:bg-white/20 text-white font-bold text-base rounded-xl border border-white/20 transition-all duration-200"
              >
