...
export const CLUBS_DATA: Record<string, ClubConfig> = {
  "leo-uwu": {
    ...
    country: "Sri Lanka",
    charterYear: 2018,
    sponsoringLionsClub: "Lions Club of Badulla",
    ...
    boardMembers: [
      {
        ...
        motto: "Leading with passion, serving with purpose for Uva Wellassa.",
      ...
      },
      {
        ...
        motto: "Dedication and teamwork drive impactful change.",
      ...
      },
      {
        ...
        motto: "Transparency and efficiency in community service.",
      ...
      },
      {
        ...
        motto: "Empowering fellow undergraduates to realize their potential.",
